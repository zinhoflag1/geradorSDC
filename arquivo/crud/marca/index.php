...
<a class="btn btn-info" href="<?= FuncaoBase::geraLink("ajuda", "marca", "pesquisa") ?>" title="Busca Registro">Pesquisa</a>
<a class="btn btn-info" href="<?= FuncaoBase::geraLink("ajuda", "marca", "exportar") ?>" title="Exportar dados Excel">Exportar Excel</a>
   <br>
<br>
...
print "<legend>Cadastro Marca</legend>";
