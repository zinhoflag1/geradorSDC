...
<legend>Cadastro de Vento</legend>
<form action="<?=FuncaoBase::geraLink("", "vento", "gravar");?>" method="post" accept-charset="utf-8" name="frmVento" id="frmVento">
