...
<a class="btn btn-info" href="<?= FuncaoBase::geraLink("ajuda", "tp_pedido", "pesquisa") ?>" title="Busca Registro">Pesquisa</a>
<a class="btn btn-info" href="<?= FuncaoBase::geraLink("ajuda", "tp_pedido", "exportar") ?>" title="Exportar dados Excel">Exportar Excel</a>
   <br>
<br>
...
print "<legend>Cadastro Tp_pedido</legend>";
...
foreach ($paginacao[0] as $tp_pedido) {
...
";
        ...
        print "<li><a href=\"" . FuncaoBase::geraLink('ajuda', 'tp_pedido', 'index', array('page' => '1')) . "\">Primeiro</a></li>";

        for ($p = 1; $p <= $paginacao[1]; $p++) {

            print "<li class=\"" . ($page == $p ? 'active' : '') . "\"><a href=\"" . FuncaoBase::geraLink('ajuda', 'tp_pedido', 'index', array('page' => $p)) . "\">" . $p . "</a></li>";
        }
        print "<li><a href=\"" . FuncaoBase::geraLink('ajuda', 'tp_pedido', 'index', array('page' => $paginacao[1])) . "\">Último</a></li>";
        print "</ul>";
        print "</div>";
