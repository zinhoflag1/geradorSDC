...
<legend>Cadastro de Tp_pedido</legend>
<form action="<?=FuncaoBase::geraLink("ajuda", "tp_pedido", "gravar");?>" method="post" accept-charset="utf-8" name="frmTp_pedido" id="frmTp_pedido">
