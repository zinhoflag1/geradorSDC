...
<a class="btn btn-info" href="<?= FuncaoBase::geraLink("ajuda", "fornecedor", "pesquisa") ?>" title="Busca Registro">Pesquisa</a>
<a class="btn btn-info" href="<?= FuncaoBase::geraLink("ajuda", "fornecedor", "exportar") ?>" title="Exportar dados Excel">Exportar Excel</a>
   <br>
<br>
...
print "<legend>Cadastro Fornecedor</legend>";
...
foreach ($paginacao[0] as $fornecedor) {
...
";
        ...
        print "<li><a href=\"" . FuncaoBase::geraLink('ajuda', 'fornecedor', 'index', array('page' => '1')) . "\">Primeiro</a></li>";

        for ($p = 1; $p <= $paginacao[1]; $p++) {

            print "<li class=\"" . ($page == $p ? 'active' : '') . "\"><a href=\"" . FuncaoBase::geraLink('ajuda', 'fornecedor', 'index', array('page' => $p)) . "\">" . $p . "</a></li>";
        }
        print "<li><a href=\"" . FuncaoBase::geraLink('ajuda', 'fornecedor', 'index', array('page' => $paginacao[1])) . "\">Último</a></li>";
        print "</ul>";
        print "</div>";
