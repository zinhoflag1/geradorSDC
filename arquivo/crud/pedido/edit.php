...
<legend>Editar Cadastro Pedido</legend>


<form action="<?=FuncaoBase::geraLink("ajuda", "pedido", "edit");?>" method="post" accept-charset="utf-8" name="frmPedido" id="frmPedido">
    
<div class='col-md-6'>
<label>Identificador do Pedido</label>
<input type="text" class='form form-control' name='id_pedido' id='id_pedido' value='<?=$view[0]['id_pedido']?>'  readonly=readonly >
</div>
<div class='col-md-6'>
<label>Tipo do Pedido</label>
<div class="input-group">
<input type="text" class='form form-control' name='nomeTp_pedido_fk' id='nomeTp_pedido_fk' value='<?=$pedidoModel->getNomeIdFk('aju_tp_pedido','id_tp_pedido', $view[0]['id_tp_pedido'])->nome;?>' required readonly='readonly'>
<span onclick="" class="input-group-addon" id="btnBuscaid_tp_pedido">
                <span class="glyphicon glyphicon-search" aria-hidden="true"></span>
            </span> </div><input type="hidden" name='id_tp_pedido' id='id_tp_pedido' required readonly='readonly' value='<?=$view[0]['id_tp_pedido']?>'>
</div>
<div class='col-md-6'>
...
<div class="input-group">
<input type="text" class='form form-control' name='nomeAlmoxarifado_fk' id='nomeAlmoxarifado_fk' value='<?=$pedidoModel->getNomeIdFk('aju_almoxarifado','id_almoxarifado', $view[0]['id_almoxarifado'])->nome;?>' required readonly='readonly'>
...
<label></label>
<div class="input-group">
<input type="text" class='form form-control' name='nomeTransportadora_fk' id='nomeTransportadora_fk' value='<?=$pedidoModel->getNomeIdFk('aju_transportadora','id_transportadora', $view[0]['id_transportadora'])->nome;?>' required readonly='readonly'>
...
<div class="input-group">
<input type="text" class='form form-control' name='nomeDestinatario_fk' id='nomeDestinatario_fk' value='<?=$pedidoModel->getNomeIdFk('aju_destinatario','id_destinatario', $view[0]['id_destinatario'])->nome;?>' required readonly='readonly'>
<span onclick="" class="input-group-addon" id="btnBuscaid_destinatario">
                <span class="glyphicon glyphicon-search" aria-hidden="true"></span>
            </span> </div><input type="hidden" name='id_destinatario' id='id_destinatario' required readonly='readonly' value='<?=$view[0]['id_destinatario']?>'>
</div>
<div class='col-md-6'>
<label>Destinatário Final</label>
<div class="input-group">
<input type="text" class='form form-control' name='nomeDestinatario_final_fk' id='nomeDestinatario_final_fk' value='<?=$pedidoModel->getNomeIdFk('aju_destinatario_final','id_destinatario_final', $view[0]['id_destinatario_final'])->nome;?>' required readonly='readonly'>
<span onclick="" class="input-group-addon" id="btnBuscaid_destinatario_final">
                <span class="glyphicon glyphicon-search" aria-hidden="true"></span>
            </span> </div><input type="hidden" name='id_destinatario_final' id='id_destinatario_final' required readonly='readonly' value='<?=$view[0]['id_destinatario_final']?>'>
</div>
<div class='col-md-6'>
<label>Nome Destinatario Final</label>
<input type="text" class='form form-control' name='nome_destinatario_final' id='nome_destinatario_final' value='<?=$view[0]['nome_destinatario_final']?>'  maxlength='69' required>
</div>
<div class='col-md-6'>
              ...
              <div class="modal-content">
                ...
                <div class="modal-footer">
                  ...
                  <div class="col-md-6 text-left">
                      <a href="<?=FuncaoBase::geraLink("ajuda", "pedido", "cadastro");?>" class="btn btn-success text-left" >Cadastrar Novo</a>
                  </div>
