...
<form action="<?=FuncaoBase::geraLink("ajuda", "evento", "gravar");?>" method="post" accept-charset="utf-8" name="frmEvento" id="frmEvento">
    
    <div class='col-md-6'>
<label>Nome Evento ou Campanha</label>
<input type="text" class='form form-control' name='nome' id='nome' maxlength='49' required >
</div>
