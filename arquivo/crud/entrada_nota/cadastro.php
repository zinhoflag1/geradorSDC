...
<legend>Cadastro de Entrada_nota</legend>
<form action="<?=FuncaoBase::geraLink("ajuda", "entrada_nota", "gravar");?>" method="post" accept-charset="utf-8" name="frmEntrada_nota" id="frmEntrada_nota">
...
<div class="input-group">
<input type="text" class='form form-control' name='nomeNatureza_fk' id='nomeNatureza_fk' required readonly='readonly'>
<span onclick="" class="input-group-addon" id="btnBuscaid_natureza">
                <span class="glyphicon glyphicon-search" aria-hidden="true"></span>
            </span> </div><input type="hidden" name='id_natureza' id='id_natureza' required readonly='readonly'>
</div>
<div class='col-md-6'>
<label>Itens notas</label>
<div class="input-group">
<input type="text" class='form form-control' name='nomeItens_nota_fk' id='nomeItens_nota_fk' required readonly='readonly'>
<span onclick="" class="input-group-addon" id="btnBuscaid_itens_nota">
                <span class="glyphicon glyphicon-search" aria-hidden="true"></span>
            </span> </div><input type="hidden" name='id_itens_nota' id='id_itens_nota' required readonly='readonly'>
</div>
<div class='col-md-6'>
            ...
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                ...
                <div class="modal-footer">
                  <!--<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>-->
                  <div class="col-md-6 text-left">
                      <a href="<?=FuncaoBase::geraLink("ajuda", "natureza", "cadastro");?>" class="btn btn-success text-left" >Cadastrar Novo</a>
                  </div>
                  <div class="col-md-6 text-right">
                      <button type="button" class="btn btn-primary" data-dismiss="modal">Fechar</button>
                  </div>
