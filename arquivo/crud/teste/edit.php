...
<form action="<?=FuncaoBase::geraLink("teste", "teste", "edit");?>" method="post" accept-charset="utf-8" name="frmTeste" id="frmTeste">
...
<input type="1" class='form form-control' name='ck_check' id='ck_check' value='<?=$view[0]['ck_check']?>'  maxlength='-1' required>
</div>
<div class='col-md-6'>
...
<div class='col-md-2'>
<label>Radio 2</label>
<input type="1" class='form form-control' name='rb_radio' id='rb_radio' value='<?=$view[0]['rb_radio']?>'  maxlength='-1' required>
</div>
