...
<legend>Cadastro de Unidade_descr</legend>
<form action="<?=FuncaoBase::geraLink("ajuda", "unidade_descr", "gravar");?>" method="post" accept-charset="utf-8" name="frmUnidade_descr" id="frmUnidade_descr">
...
<script>
    ...
    $(document).ready(function () {
        $("#frmUnidade_descr").trigger("reset");
