...
<legend>Editar Cadastro Unidade</legend>


<form action="<?=FuncaoBase::geraLink("ajuda", "unidade", "edit");?>" method="post" accept-charset="utf-8" name="frmUnidade" id="frmUnidade">
    
<div class='col-md-6'>
<label>Identificador</label>
<input type="text" class='form form-control' name='id_unidade' id='id_unidade' value='<?=$view[0]['id_unidade']?>'  readonly=readonly >
</div>
<div class='col-md-6'>
...
<input type="text" class='form form-control' name='descricao' id='descricao' value='<?=$view[0]['descricao']?>'  maxlength='69' required>
</div>
<div class='col-md-6'>
<label>Valor Material</label>
<input type="text" class='form form-control' name='valor' id='valor' value='<?=$view[0]['valor']?>'  maxlength='-1' required>
</div>
<div class='col-md-6'>
<label>Validade Material</label>
<input type="text" class='form form-control' name='data_validade' id='data_validade' value='<?=DataMysql::dataVisual($view[0]['data_validade'])?>'  maxlength='-1' required>
</div>
<div class='col-md-6'>
<label>Identificador Marca</label>
<div class="input-group">
<input type="text" class='form form-control' name='nomeMarca_fk' id='nomeMarca_fk' value='<?=$unidadeModel->getNomeIdFk('aju_marca','id_marca', $view[0]['id_marca'])->nome;?>' required readonly='readonly'>
<span onclick="" class="input-group-addon" id="btnBuscaid_marca">
                <span class="glyphicon glyphicon-search" aria-hidden="true"></span>
            </span> </div><input type="hidden" name='id_marca' id='id_marca' required readonly='readonly' value='<?=$view[0]['id_marca']?>'>
</div>
<div class='col-md-6'>
<label>Identificador Categoria</label>
<div class="input-group">
<input type="text" class='form form-control' name='nomeCategoria_fk' id='nomeCategoria_fk' value='<?=$unidadeModel->getNomeIdFk('aju_categoria','id_categoria', $view[0]['id_categoria'])->nome;?>' required readonly='readonly'>
<span onclick="" class="input-group-addon" id="btnBuscaid_categoria">
                <span class="glyphicon glyphicon-search" aria-hidden="true"></span>
            </span> </div><input type="hidden" name='id_categoria' id='id_categoria' required readonly='readonly' value='<?=$view[0]['id_categoria']?>'>
</div>
<div class='col-md-6'>
<label>Identificador Almoxarifado</label>
<div class="input-group">
<input type="text" class='form form-control' name='nomeAlmoxarifado_fk' id='nomeAlmoxarifado_fk' value='<?=$unidadeModel->getNomeIdFk('aju_almoxarifado','id_almoxarifado', $view[0]['id_almoxarifado'])->nome;?>' required readonly='readonly'>
...
<div class="input-group">
<input type="text" class='form form-control' name='nomeFornecedor_fk' id='nomeFornecedor_fk' value='<?=$unidadeModel->getNomeIdFk('aju_fornecedor','id_fornecedor', $view[0]['id_fornecedor'])->nome;?>' required readonly='readonly'>
...
<div class="input-group">
<input type="text" class='form form-control' name='nomeUnidade_med_fk' id='nomeUnidade_med_fk' value='<?=$unidadeModel->getNomeIdFk('aju_unidade_med','id_unidade_med', $view[0]['id_unidade_med'])->nome;?>' required readonly='readonly'>
<span onclick="" class="input-group-addon" id="btnBuscaid_unidade_med">
                <span class="glyphicon glyphicon-search" aria-hidden="true"></span>
            </span> </div><input type="hidden" name='id_unidade_med' id='id_unidade_med' required readonly='readonly' value='<?=$view[0]['id_unidade_med']?>'>
</div>
