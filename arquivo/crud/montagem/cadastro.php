...
<input type="text" class='form form-control' name='data_montagem' id='data_montagem' maxlength='' required >
</div>
<div class='col-md-6'>
...
<input type="text" class='form form-control' name='placa' id='placa' maxlength='44' required >
</div>
<div class='col-md-6'>
<label></label>
