...
<table class="table table-bordered table-striped">
    ...
    <tr>
                <td class="col-md-3"> :</td><td><?=$view[0]['id_baixa'];?></td>
            </tr></div>
...
<tr>
                <td class="col-md-3"> :</td><td><?=$view[0]['id_deposito'];?></td>
            </tr></div>
...
<tr>
                <td class="col-md-3"> :</td><td><?=$view[0]['motivo'];?></td>
            </tr></div>
...
<a class="btn btn-info" href="<?= FuncaoBase::geraLink("ajuda", "baixa", "edit", array('id'=>$view[0]['id_baixa'])) ?>">Editar</a>
<br>
<br>
