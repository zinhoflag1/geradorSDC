...
<legend>Editar Cadastro Destinatario</legend>


<form action="<?=FuncaoBase::geraLink("ajuda", "destinatario", "edit");?>" method="post" accept-charset="utf-8" name="frmDestinatario" id="frmDestinatario">
    
<div class='col-md-6'>
<label>Id Destinatario</label>
<input type="text" class='form form-control' name='id_destinatario' id='id_destinatario' value='<?=$view[0]['id_destinatario']?>'  readonly=readonly >
</div>
<div class='col-md-6'>
