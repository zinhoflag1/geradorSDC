...
<legend>Cadastro de Natureza</legend>
<form action="<?=FuncaoBase::geraLink("ajuda", "natureza", "gravar");?>" method="post" accept-charset="utf-8" name="frmNatureza" id="frmNatureza">
