...
<a class="btn btn-info" href="<?= FuncaoBase::geraLink("ajuda", "natureza", "pesquisa") ?>" title="Busca Registro">Pesquisa</a>
<a class="btn btn-info" href="<?= FuncaoBase::geraLink("ajuda", "natureza", "exportar") ?>" title="Exportar dados Excel">Exportar Excel</a>
   <br>
<br>
...
print "<legend>Cadastro Natureza</legend>";
...
foreach ($paginacao[0] as $natureza) {
...
";
        ...
        print "<li><a href=\"" . FuncaoBase::geraLink('ajuda', 'natureza', 'index', array('page' => '1')) . "\">Primeiro</a></li>";

        for ($p = 1; $p <= $paginacao[1]; $p++) {

            print "<li class=\"" . ($page == $p ? 'active' : '') . "\"><a href=\"" . FuncaoBase::geraLink('ajuda', 'natureza', 'index', array('page' => $p)) . "\">" . $p . "</a></li>";
        }
        print "<li><a href=\"" . FuncaoBase::geraLink('ajuda', 'natureza', 'index', array('page' => $paginacao[1])) . "\">Último</a></li>";
        print "</ul>";
        print "</div>";
