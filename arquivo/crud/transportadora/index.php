...
<a class="btn btn-info" href="<?= FuncaoBase::geraLink("ajuda", "transportadora", "pesquisa") ?>" title="Busca Registro">Pesquisa</a>
<a class="btn btn-info" href="<?= FuncaoBase::geraLink("ajuda", "transportadora", "exportar") ?>" title="Exportar dados Excel">Exportar Excel</a>
   <br>
<br>
...
$numRegPorPagina = 10;
$pag = new TransportadoraController();
...
print "<legend>Cadastro Transportadora</legend>";
...
foreach ($paginacao[0] as $transportadora) {
...
";
        ...
        print "<li><a href=\"" . FuncaoBase::geraLink('ajuda', 'transportadora', 'index', array('page' => '1')) . "\">Primeiro</a></li>";

        for ($p = 1; $p <= $paginacao[1]; $p++) {

            print "<li class=\"" . ($page == $p ? 'active' : '') . "\"><a href=\"" . FuncaoBase::geraLink('ajuda', 'transportadora', 'index', array('page' => $p)) . "\">" . $p . "</a></li>";
        }
        print "<li><a href=\"" . FuncaoBase::geraLink('ajuda', 'transportadora', 'index', array('page' => $paginacao[1])) . "\">Último</a></li>";
        print "</ul>";
        print "</div>";
