...
<table class="table table-bordered table-striped">
    ...
    <tr>
                <td class="col-md-3">Id Destinatario :</td><td><?=$view[0]['id_dest'];?></td>
            </tr></div>
...
<a class="btn btn-info" href="<?= FuncaoBase::geraLink("ajuda", "dest", "edit", array('id'=>$view[0]['id_dest'])) ?>">Editar</a>
<br>
<br>
