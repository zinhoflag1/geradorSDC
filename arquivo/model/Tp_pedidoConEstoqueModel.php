 ...
 *
 * 	Classe para manipulacao da tabela aju_tp_pedido										*
 * 																					*
...
class Tp_pedidoConEstoqueModel extends Model {

    
    private $table = "aju_tp_pedido";
    public static $model;
    private static $mod;
    private $marca;
    private static $con;
 ...
 public function getNome(){
    ...
    #################  CONSTRUTOR ##################
     function __construct() {
         ...
         self::$model = $this->Tabela('aju_tp_pedido');
   ...
   # lista {$model}
    ...
    public static function gravar(array $dados) {
        ...
        var_dump(self::$model);
        $sql = "INSERT INTO aju_tp_pedido (nome 
) VALUES (:nome 
)";
    ...
    public static function edit(array $dados) {
        ...
        $sql = "UPDATE aju_tp_pedido SET 
        nome= :nome
            WHERE id_tp_pedido = :id_tp_pedido";
        ...
        try {
            ...
            #Log::GravaLog("Atualizar Cadastro de Tp_pedido : " . $dados['nome'] . " " . $_COOKIE['seguranca']['login'], "aju_log");
     ...
     * View Marca
     */
    public static function view($id_tp_pedido) {

        $con = Conexao::getInstance();

        $fornecedor = "";

        $sql = "SELECT aju_tp_pedido.id_tp_pedido,
aju_tp_pedido.nome
                              FROM aju_tp_pedido
        ...
        try {
           ...
           $model = self::$model;
            return array($tp_pedido, $model);
        } catch (Exception $e) {
            return $e->getMessage() . "Erro ao inserir Tp_pedido";
        }
    }
    ...
    public function paginacao($start, $regPorPagina){
        $con = Conexao::getInstance();
            ...
            $stmt = $con->prepare("SELECT aju_tp_pedido.id_tp_pedido,
aju_tp_pedido.nome
                                FROM aju_tp_pedido
                                
                                ORDER By id_tp_pedido DESC LIMIT $start, $regPorPagina");
            $stmt->execute();
    ...
    public static function delete($id) {
        ...
        $sql = "DELETE FROM aju_tp_pedido WHERE id_tp_pedido = " . $id;
        ...
        try {
            ...
            return $e->getMessage() . "Erro Deletar Tp_pedido !";
        }
    }
     ...
     * Lista tp_pedido
     */
    public function listatp_pedidos() {
