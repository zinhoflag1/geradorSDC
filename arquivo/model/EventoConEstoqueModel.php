 ...
 *
 * 	Classe para manipulacao da tabela aju_evento										*
 * 																					*
...
class EventoConEstoqueModel extends Model {

    
    private $table = "aju_evento";
    public static $model;
    private static $mod;
    private $marca;
    private static $con;
 ...
 public function getNome(){
    ...
    #################  CONSTRUTOR ##################
     function __construct() {
         ...
         self::$model = $this->Tabela('aju_evento');
   ...
   # lista {$model}
    ...
    public static function edit(array $dados) {
        ...
        try {
            ...
            $result->bindValue(":id_evento", $dados['id_evento']);
            $result->bindValue(":nome", $dados['nome']);

            
            $result->execute();

            #Log::GravaLog("Atualizar Cadastro de Evento : " . $dados['nome'] . " " . $_COOKIE['seguranca']['login'], "aju_log");
     ...
     * View Marca
     */
    public static function view($id_evento) {

        $con = Conexao::getInstance();

        $fornecedor = "";

        $sql = "SELECT aju_evento.id_evento,
aju_evento.nome
                              FROM aju_evento
        ...
        try {
           ...
           $model = self::$model;
            return array($evento, $model);
        } catch (Exception $e) {
            return $e->getMessage() . "Erro ao inserir Evento";
        }
    }
    ...
    public function paginacao($start, $regPorPagina){
        $con = Conexao::getInstance();
            ...
            $stmt = $con->prepare("SELECT aju_evento.id_evento,
aju_evento.nome
                                FROM aju_evento
                                
                                ORDER By id_evento DESC LIMIT $start, $regPorPagina");
            $stmt->execute();
    ...
    public static function delete($id) {
        ...
        $sql = "DELETE FROM aju_evento WHERE id_evento = " . $id;
        ...
        try {
            ...
            return $e->getMessage() . "Erro Deletar Evento !";
        }
    }
