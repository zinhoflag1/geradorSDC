 ...
 *
 * 	Classe para manipulacao da tabela aju_unidade_med										*
 * 																					*
...
class Unidade_medConEstoqueModel extends Model {

    
    private $table = "aju_unidade_med";
    public static $model;
    private static $mod;
    private $marca;
    private static $con;
 ...
 public function getNome(){
    ...
    #################  CONSTRUTOR ##################
     function __construct() {
         ...
         self::$model = $this->Tabela('aju_unidade_med');
   ...
   # lista {$model}
    ...
    public static function gravar(array $dados) {
        ...
        var_dump(self::$model);
        $sql = "INSERT INTO aju_unidade_med (nome 
) VALUES (:nome 
)";
    ...
    public static function edit(array $dados) {
        ...
        $sql = "UPDATE aju_unidade_med SET 
        nome= :nome
            WHERE id_unidade_med = :id_unidade_med";
        ...
        try {
            ...
            #Log::GravaLog("Atualizar Cadastro de Unidade_med : " . $dados['nome'] . " " . $_COOKIE['seguranca']['login'], "aju_log");
     ...
     * View Marca
     */
    public static function view($id_unidade_med) {

        $con = Conexao::getInstance();

        $fornecedor = "";

        $sql = "SELECT aju_unidade_med.id_unidade_med,
aju_unidade_med.nome
        ...
        try {
           ...
           $model = self::$model;
            return array($unidade_med, $model);
        } catch (Exception $e) {
            return $e->getMessage() . "Erro ao inserir Unidade_med";
        }
    }
    ...
    public function paginacao($start, $regPorPagina){
        $con = Conexao::getInstance();
            ...
            $stmt = $con->prepare("SELECT aju_unidade_med.id_unidade_med,
aju_unidade_med.nome
                                FROM aju_unidade_med
                                
                                ORDER By id_unidade_med DESC LIMIT $start, $regPorPagina");
            $stmt->execute();
    ...
    #################  DELETAR  ##################
    # @ deletar o unidade_med

    public static function delete($id) {

        $con = Conexao::getInstance();

        $sql = "DELETE FROM aju_unidade_med WHERE id_unidade_med = " . $id;
        ...
        try {
            ...
            return $e->getMessage() . "Erro Deletar Unidade_med !";
        }
    }
     ...
     * Lista unidade_med
     */
    public function listaunidade_meds() {
