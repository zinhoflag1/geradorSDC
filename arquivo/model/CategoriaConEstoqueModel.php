...
class CategoriaConEstoqueModel extends Model {

    
    private $table = "aju_categoria";
    public static $model;
    private static $mod;
    private $marca;
    private static $con;
 ...
 public function getNome(){
    ...
    #################  CONSTRUTOR ##################
     function __construct() {
         ...
         self::$model = $this->Tabela('aju_categoria');
   ...
   # lista {$model}
    ...
    public static function gravar(array $dados) {
        ...
        var_dump(self::$model);
        $sql = "INSERT INTO aju_categoria (nome 
) VALUES (:nome 
)";
     ...
     * View Marca
     */
    public static function view($id_categoria) {

        $con = Conexao::getInstance();

        $fornecedor = "";

        $sql = "SELECT aju_categoria.id_categoria,
aju_categoria.nome
                              FROM aju_categoria
        ...
        try {
           ...
           $model = self::$model;
            return array($categoria, $model);
        } catch (Exception $e) {
            return $e->getMessage() . "Erro ao inserir Categoria";
        }
    }
    ...
    public function paginacao($start, $regPorPagina){
        $con = Conexao::getInstance();
            ...
            $stmt = $con->prepare("SELECT aju_categoria.id_categoria,
aju_categoria.nome
                                FROM aju_categoria
                                
                                ORDER By id_categoria DESC LIMIT $start, $regPorPagina");
            $stmt->execute();
    ...
    public static function delete($id) {
        ...
        $sql = "DELETE FROM aju_categoria WHERE id_categoria = " . $id;
        ...
        try {
            ...
            return $e->getMessage() . "Erro Deletar Categoria !";
        }
    }
