 ...
 *
 * 	Classe para manipulacao da tabela evento										*
 * 																					*
   ...
   # lista {$model}
    ...
    public static function edit(array $dados) {
        ...
        try {
            ...
            $result->bindValue(":", $dados['']);
            
            
            $result->execute();

            #Log::GravaLog("Atualizar Cadastro de Vento : " . $dados['nome'] . " " . $_COOKIE['seguranca']['login'], "aju_log");
     ...
     * View Marca
     */
    public static function view($id_vento) {
        ...
        try {
           ...
           $model = self::$model;
            return array($vento, $model);
        } catch (Exception $e) {
            return $e->getMessage() . "Erro ao inserir Vento";
        }
    }
    ...
    public function paginacao($start, $regPorPagina){
        $con = Conexao::getInstance();
            ...
            $stmt = $con->prepare("SELECT 
                                ...
                                ORDER By id_vento DESC LIMIT $start, $regPorPagina");
            $stmt->execute();
    ...
    public static function delete($id) {
        ...
        $sql = "DELETE FROM evento WHERE id_vento = " . $id;
        ...
        try {
            ...
            return $e->getMessage() . "Erro Deletar Vento !";
        }
    }
